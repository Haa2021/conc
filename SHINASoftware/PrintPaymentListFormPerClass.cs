...
{
    public partial class PrintPaymentListFormPerClass : Form
    {
        public PrintPaymentListFormPerClass()
        {
            InitializeComponent();
            FillClass();
            FillAcademicYear();
        ...
        void FillPupil()
        {
            ...
            //        "FROM student S, tuitionfees E, academicyear A, class C " +
            //        "WHERE E.StudentID = S.StudentID AND E.AcademicYearID = A.AcademicYearID AND E.classID = C.ClassID " +
            //        " AND (E.classID = '" + this.lblClassID.Text + "' && E.ClassRoomName LIKE '%" + this.cmbClassRoomName.Text + "%' && E.AcademicYearID = '" + this.lblAcademicYearID.Text + "');";
        ...
        private void BtnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "SELECT S.IDNO AS IDNO, S.FullName AS FullName, C.ClassName AS ClassName, E.ClassRoomName AS ClassRoomName, A.AcademicYear AS AcademicYear, E.ORNO AS ORNO, E.PaymentDate As PaymentDate, " +
                    "F.EssentialFees AS EssentialFees, E.SchoolFeesPaid AS SchoolFeesPaid, E.SchoolFeesBalance AS SchoolFeesBalance, E.PaymentDate AS PaymentDate " +
                    "FROM student S, tuitionfees E, academicyear A, class C, essentialfees F " +
                    "WHERE E.StudentID = S.StudentID AND E.AcademicYearID = A.AcademicYearID AND F.classID = C.ClassID " +
                    "AND E.classID = C.ClassID AND (E.classID = '" + this.lblClassID.Text + "' && E.ClassRoomName LIKE '%" + this.cmbClassRoomName.Text + "%' && E.AcademicYearID = '" + this.lblAcademicYearID.Text + "' && E.StudentID = '" + this.lblStudentID.Text + "') ";
                MySqlConnection MyConn2 = new MySqlConnection(SHINAConnection);
                MySqlCommand MyCommand2 = new MySqlCommand(Query, MyConn2);
                MySqlDataReader MyReader2;
                MyConn2.Open();
                ...
                PaidPupilPerClassYearPupilDS DS = new PaidPupilPerClassYearPupilDS();
                PaidPupilPerClassYearPupilCR rpt = new PaidPupilPerClassYearPupilCR();
                MyAdapter.Fill(DS, "PaidPupilPerClassYearPupil");
        ...
        private void CmbName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                string Query = "SELECT * FROM student WHERE  FullName = '" + this.cmbName.Text + "';";
                MySqlConnection MyConn2 = new MySqlConnection(SHINAConnection);
                MySqlCommand MyCommand2 = new MySqlCommand(Query, MyConn2);
                MySqlDataReader MyReader2;
                MyConn2.Open();
