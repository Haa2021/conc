...
{
    public partial class PupilsForm : FormDashboard
    {
        public PupilsForm()
        {
            InitializeComponent();
        ...
        private void PupilsForm_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        comm.Parameters.AddWithValue("@param7", dtpDob.Text.Trim());
