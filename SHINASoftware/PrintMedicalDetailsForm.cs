...
{
    public partial class PrintMedicalDetailsForm : Form
    {
        public PrintMedicalDetailsForm()
        {
            InitializeComponent();
            FillClass();
            FillAcademicYear();
        ...
        private void BtnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "SELECT S.IDNO AS IDNO, S.FullName AS FullName, M.BloodGroup AS BloodGroup, M.AllergyIllness AS AllergyIllness, M.NatureOfAllergyIllness AS NatureOfAllergyIllness," +
                    ...
                    "WHERE M.StudentID = S.StudentID AND T.AcademicYearID = A.AcademicYearID AND T.classID = C.ClassID AND T.StudentID = S.StudentID AND S.FlagStudentEnrolledPaid = '1' AND (T.ClassID LIKE '%" + this.lblClassID.Text + "%' && T.ClassroomName LIKE '%" + this.cmbClassRoomName.Text + "%' && T.AcademicYearID LIKE '%" + this.lblAcademicYearID.Text + "%') AND M.Disabled = 'Yes' " +
                ...
                MedicalDetailsCR rpt = new MedicalDetailsCR();
                MyAdapter.Fill(DS, "MedicalDetails");
