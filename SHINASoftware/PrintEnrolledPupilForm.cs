...
{
    public partial class PrintEnrolledPupilForm : Form
    {
        public PrintEnrolledPupilForm()
        {
            InitializeComponent();
            FillClass();
            FillAcademicYear();
        ...
        private void BtnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                EnrolledStudentsCR rpt = new EnrolledStudentsCR();
                MyAdapter.Fill(DS, "EnrolledStudents");
