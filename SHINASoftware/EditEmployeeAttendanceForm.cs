...
{
    public partial class EditEmployeeAttendanceForm : Form
    {
        ...
        private void BtnEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (MessageBox.Show("Do you really want to edit the informations of the Employee = '" + this.txtFullname.Text + "'  EIN = '" + this.txtEIN.Text + "'  ?", "Confirm the change", MessageBoxButtons.OKCancel) == DialogResult.OK)
                {
                    //////int count = 0;
                    ...
                    ////{
                        ...
                        MyConn2.Open();
                        MySqlCommand comm = new MySqlCommand("UpdateEmployeeAttendance", MyConn2);

                        comm.CommandType = CommandType.StoredProcedure;

                        comm.Parameters.AddWithValue("@param1", lblCheckAttendanceEmployeeID.Text);
                        ...
                        comm.Parameters.AddWithValue("@param4", lblStatus.Text);
